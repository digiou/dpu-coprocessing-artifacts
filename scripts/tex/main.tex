...
\newcommand\vldbavailabilityurl{https://github.com/digiou/dpu-coprocessing-artifacts}
% whether page numbers should be shown or not, use 'plain' for review versions, 'empty' for camera ready
\newcommand\vldbpagestyle{plain} 

\begin{document}
\title{Reproducibility Report for Vol. 18, Paper ID 2564 ``Analyzing Near-Network Hardware Acceleration with Co-Processing on DPUs''}

\author{Dimitrios Giouroukis}
\affiliation{%
  \institution{BIFOLD, TU Berlin}
}
\email{dimitrios.giouroukis@tu-berlin.de}
...
\begin{figure*}[t]
    \centering
    \ref{coprocessing-legend}

    \begin{subfigure}[b]{0.242\textwidth}
        \includegraphics[width=\textwidth]{figures/coprocessing-compress.tex}
        \caption{Compress (BF2)}
        \label{subfig:coprocessing-compress}
    \end{subfigure}
    \hspace{0.002\textwidth}
    \begin{subfigure}[b]{0.242\textwidth}
        \includegraphics[width=\textwidth]{figures/coprocessing-decompress-deflate.tex}
        \caption{Decompress (BF2, BF3)}
        \label{subfig:coprocessing-decompress-deflate}
    \end{subfigure}
    \hspace{0.002\textwidth}
    \begin{subfigure}[b]{0.242\textwidth}
        \includegraphics[width=\textwidth]{figures/coprocessing-decompress-lz4-bf3.tex}
        \caption{LZ4 Decomp. (BF3)}
        \label{subfig:coprocessing-lz4}
    \end{subfigure}
    \hspace{0.002\textwidth}
    \begin{subfigure}[b]{0.242\textwidth}
        \includegraphics[width=\columnwidth]{figures/cpu-reduction.tex}
        \caption{Host CPU Savings}
        \label{subfig:cpu-reduction}
    \end{subfigure}
    \caption{Co-processing results per task on BF2 and BF3 for Static and Reconfiguration scenarios from Host and ARM.}
...
\begin{figure}[t]
    \centering
    \ref{routing-impact-legend}

    \begin{subfigure}[b]{0.435\columnwidth}
        \includegraphics[width=\columnwidth]{figures/iperf-impact-tput.tex}
        \caption{Throughput}
        \label{fig:iperf-tput}
    \end{subfigure}
    \hspace{0.0115\columnwidth}
    \begin{subfigure}[b]{0.44\columnwidth}
        \includegraphics[width=\columnwidth]{figures/iperf-impact-latency.tex}
        \caption{Latency}
        \label{fig:iperf-latency}
    \end{subfigure}
    \caption{Co-processing impact during data routing.}
    \label{fig:iperf-results}
\end{figure}
